...
- [ ] **Минимальный MVP** (шаги 1–5, включая 2.5 и 3.5, и 9): JSON mode + raw mode, `--method`, `--input`, `-f`, `-i`, `--timeout`, загрузка конфига, аутентификация, контракт stdout/stderr + тесты.
